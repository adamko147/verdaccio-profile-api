...
var mock_authenticate = jest.fn((user, password, cb) => {
  cb(null, (user === 'adam2' && password === 'Welcome1') ? [user] : false);
});
...
describe('verdaccio 2.x', () => {
  beforeEach(() => fs.mock({"/mocked_htpasswd": "adam2:$6abcdefghijk:autocreated 2018-06-04T21:47:11.284Z\n"}));
